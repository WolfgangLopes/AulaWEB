...
function trataEventos1(event){
    switch(event.type){
        case "click":       elemento1.style.backgroundColor = "green";
                            break;
        case "dblclick":    elemento1.style.backroundColor = "blue";
                            break;
    }
}
    function trataEventos2(event){
        switch(event.type){
            ...
            case "mousedown":   elemento2.style.backgroundColor = "black";
                                break;
            case "mouseout":   elemento2.style.backgroundColor = "white";
                                break;
            case "mouseup":   elemento2.style.backgroundColor = "yellow";
                                break;                    
            case "mousemove":   elemento2.innerHTML = "x:"+event.clientX+", y:"
            +event.clientY;
                                break;                    
        }
    }
